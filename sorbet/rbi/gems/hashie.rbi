...
module Hashie::Extensions::DeepLocate
  ...
  def self._deep_locate(comparator, object, result = nil); end
  def self._match_comparator?(value, comparator, object); end
  def self.activesupport_indifferent?(object); end
  def self.deep_locate(comparator, object); end
end
module Hashie::Extensions::DeepFind
  def _deep_find(key, object = nil); end
  def _deep_find_all(key, object = nil, matches = nil); end
